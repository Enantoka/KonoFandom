...
namespace KonoFandom.Data {
    public class SeedData
    {
        public static void Intialize(IServiceProvider serviceProvider)
        {
            ...
            {
                bool inDev = false; // Edit in future
                string query;

                if (inDev)
                {
                    query = "TRUNCATE TABLE character, card, card_basic_skill, card_element, effect, element, skill, skill_status_effect RESTART IDENTITY";
